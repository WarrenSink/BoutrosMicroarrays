...
title: A template for the \emph{arxiv} style authors: - name: Warren
Sink thanks: Zacharewski Lab department: Biochemistry and Molecular
Biology affiliation: Michigan State University location: East Lansing,
MI 49506 email:
\href{mailto:sinkwarr@msu.edu}{\nolinkurl{sinkwarr@msu.edu}} abstract:
\textbar{}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{(\columnwidth - 0\tabcolsep) * \real{0.06}}\raggedright
keywords: - AhR - TCDD - Microarray - Functional Enrichment - Boutros
bibliography: references.bib biblio-style: unsrt output:
rticles::arxiv\_article\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
\begin{figure}
\centering
\includegraphics{Differentially-regulated-genes-by-the-AhR-using--Ahr--null-mice-and-the-AhR-selective-ligand,-TCDD_files/figure-latex/fig2-1.pdf}
